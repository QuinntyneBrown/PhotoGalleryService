...
const template = require("./photo-gallery-item.component.html");
const styles = require("./photo-gallery-item.component.scss");

export class PhotoGalleryItemComponent extends HTMLElement {
    constructor(
    ...
    private async _onDeleteClick(e:Event) {
        await this._photoGalleryService.remove({ id: this.entity.id });        
        this.parentNode.removeChild(this);
    }

    private _onEditClick() {
        this._router.navigate(["photo-gallery", "edit", this.entity.id]);
    }

    private _onViewClick() {
        this._router.navigate(["photo-gallery","view",this.entity.id]);
    }
...
customElements.define(`ce-photo-gallery-item`,PhotoGalleryItemComponent);
