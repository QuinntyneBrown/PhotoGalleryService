...
const template = require("./photo-gallery-slide-item-embed.component.html");
const styles = require("./photo-gallery-slide-item-embed.component.scss");

export class PhotoGallerySlideItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new PhotoGallerySlideDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new PhotoGallerySlideEdit(this.entity));
    }
    ...
    public entity: PhotoGallerySlide;
}

customElements.define(`ce-photo-gallery-slide-item-embed`,PhotoGallerySlideItemEmbedComponent);
