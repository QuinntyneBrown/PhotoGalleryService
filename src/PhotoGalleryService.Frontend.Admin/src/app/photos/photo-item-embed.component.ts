...
const template = require("./photo-item-embed.component.html");
const styles = require("./photo-item-embed.component.scss");

export class PhotoItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new PhotoDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new PhotoEdit(this.entity));
    }
...
customElements.define(`ce-photo-item-embed`,PhotoItemEmbedComponent);
